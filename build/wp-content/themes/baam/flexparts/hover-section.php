<section class="cta-big pb-4">
	<div class="container-fluid px-0">
		<div class="row align-content-stretch">
			<div class="col-xl-5 col-md-6 pl-0 pr-2 card-reveal hover-effect-section">
			...
			<div class="col-xl-7 col-md-6 pr-0 hover-effect-section">
				<div class="h-100 card border-0 border-radius p-0 overflow-hidden" style="background-color: <?php echo get_sub_field('background_colour'); ?>;">
